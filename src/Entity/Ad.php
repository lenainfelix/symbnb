...
class Ad
{
    ...
    /**
     * Permet de récuperer le commentaire d'un auteru par rapport a une annonces
     *
     * @param User $author
     * @return Comment|null
     */
    ...
    /**
     * permet d'obtenir la note moyenne des annonces
     *
     * @return float
     */
    public function getAvgRatings(){
        ...
        if ( count($this->comments) > 0){
            ...
            $avgRatings = $somme / count($this->comments);
        }
        else
        {
            $avgRatings = 0;
    ...
    /**
     * Permet d'obtenir les jours d'indisponibilité du logement
     *
     * 
    ...
    public function getNotAvailableDays()
    {
        ...
        {
            //calcul des jours d'indisponibilite
            $resultat= range(
